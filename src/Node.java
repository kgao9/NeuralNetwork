...
public class Node{
	...
	public void calculateOutput()
	{
		...
		{
			// TODO: add code here
            // for each parent node weight pair,
            // use ReLU function. That is g(x) = max(0,x)
            // where x = sum(i = 1...n)wixi
                        
            double reLUInput = 0.0;
            ...
            //use function( max(0, input))
            if(reLUInput >= 0)
            	this.outputValue = reLUInput;
